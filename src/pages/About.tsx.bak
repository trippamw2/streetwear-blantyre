  ...
  <div>
    ...
    <section className="container py-14 sm:py-20">
      <div className="max-w-3xl space-y-5">
        ...
        <p className="text-lg sm:text-xl text-gray-500 leading-relaxed">
          PowerPod keeps you charged and connected. We pick the right gear for your phone so you don't have to.
        </p>
      </div>
    </section>
    ...
    <section className="container py-16">
      <div className="grid md:grid-cols-3 gap-6">
        {[
          { icon: Zap, title: "Power", text: "Energy that follows you." },
    ...
    <section className="container pb-14">
      <div className="rounded-3xl p-10 sm:p-16 bg-gradient-brand text-white text-center space-y-5">
        ...
        <p className="text-white/85 max-w-xl mx-auto">Keep the vibe alive. Order on WhatsApp.</p>
