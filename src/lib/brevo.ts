...
const ADMIN_EMAIL = import.meta.env.VITE_ADMIN_EMAIL || "streetwearblantyre.mw@gmail.com";

// Brand configuration
const BRAND = {
  name: "Streetwear Blantyre",
  tagline: "Wear the Culture",
  email: "orders@streetwearblantyre.mw",
  website: "https://streetwearblantyre-store.vercel.app",
            ...
            <td style="background: linear-gradient(135deg, #FF6B00 0%, #FF8C00 50%, #FF6B00 100%); padding: 40px 32px; position: relative; overflow: hidden;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center">
                    <!-- Logo icon -->
                    <div style="display: inline-block; width: 64px; height: 64px; background: rgba(255,255,255,0.9); border-radius: 20px; line-height: 64px; font-size: 24px; font-weight: 800; color: #FF6B00; margin-bottom: 16px;">SB</div>
                    <!-- Brand name -->
...
export const sendDispatchedEmail = async (order: OrderEmailParams) => {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p style="margin-top: 16px;">Track: <a href="https://streetwearblantyre-store.vercel.app/track/${order.orderId}" style="color: #FF6B00;">streetwearblantyre-store.vercel.app/track/${order.orderId.slice(0, 8)}</a></p>
      <p style="margin-top: 24px;">Thanks, Streetwear Blantyre Team</p>
    </div>
  `;
...
export const sendDeliveredEmail = async (order: OrderEmailParams) => {
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p>Please leave a review: <a href="https://streetwearblantyre-store.vercel.app/reviews" style="color: #FF6B00;">streetwearblantyre-store.vercel.app/reviews</a></p>
  ...
  const html = `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <p style="margin-top: 16px;">
        <a href="https://streetwearblantyre-store.vercel.app/admin/orders" style="background: #FF6B00; color: white; padding: 12px 24px; text-decoration: none; border-radius: 8px;">View in Admin</a>
      </p>
    </div>
  `;
